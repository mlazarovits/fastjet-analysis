...
// Wed May 11 14:44:56 2022 by ROOT version 6.18/02
// from TTree Delphes/Analysis tree
// found on file: weakbosons.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTrack = 4;
   static constexpr Int_t kMaxTower = 4;
   static constexpr Int_t kMaxEFlowTrack = 4;
   static constexpr Int_t kMaxEFlowPhoton = 4;
   ...
   static constexpr Int_t kMaxFatJet = 3;
   ...
   Int_t           Weight_ID[kMaxWeight];   //[Weight_]
   ...
   Float_t         Particle_decayX[kMaxParticle];   //[Particle_]
   Float_t         Particle_decayY[kMaxParticle];   //[Particle_]
   Float_t         Particle_decayZ[kMaxParticle];   //[Particle_]
   Float_t         Particle_decayT[kMaxParticle];   //[Particle_]
   Int_t           Particle_size;
   Int_t           Track_;
   ...
   TBranch        *b_Particle_decayX;   //!
   TBranch        *b_Particle_decayY;   //!
   TBranch        *b_Particle_decayZ;   //!
   TBranch        *b_Particle_decayT;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("weakbosons.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("weakbosons.root");
      }
...
void Delphes::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Weight.ID", &Weight_ID, &b_Weight_ID);
   ...
   fChain->SetBranchAddress("Particle.decayX", Particle_decayX, &b_Particle_decayX);
   fChain->SetBranchAddress("Particle.decayY", Particle_decayY, &b_Particle_decayY);
   fChain->SetBranchAddress("Particle.decayZ", Particle_decayZ, &b_Particle_decayZ);
   fChain->SetBranchAddress("Particle.decayT", Particle_decayT, &b_Particle_decayT);
